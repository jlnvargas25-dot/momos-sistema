...
1. Aplicar `supabase/kling-conector-v1.sql` después del paso 24 y H109-S
...
7. En Agencia MOMOS → Integraciones, Administración prepara la reanudación y
   repite el health-check. Preparar no genera, no cobra y no publica.
