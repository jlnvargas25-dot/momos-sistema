...
for (const requiredFragment of [
  ...
  "piloto-generacion-controlado-v1.sql",
  "test-piloto-generacion-controlado-v1.sql",
  "formatos-video-produccion-v1.sql",
  "test-formatos-video-produccion-v1.sql",
  "calidad-maestra-biblioteca-ia-v1.sql",
  "test-calidad-maestra-biblioteca-ia-v1.sql",
  "higgsfield-conciliacion-v1.sql",
  "test-higgsfield-conciliacion-v1.sql",
