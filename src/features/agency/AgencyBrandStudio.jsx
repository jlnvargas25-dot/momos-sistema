...
function VisualQualityReviewFields({ form, onChange }) {
  ...
  return <div className="rounded-2xl border p-3 mt-3" style={{ borderColor: "#B8D3B2", background: "#F4FAF2" }}>
    ...
    <div className="text-[10px] mt-1 mb-3" style={{ color: T.choco2 }}>Marcá los seis controles revisados. Los defectos determinan si corresponde mejorar, repetir la toma o habilitar imagen, video y Element.</div>
