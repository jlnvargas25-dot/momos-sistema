...
const agencyPanel = read("../features/agency/AgencyPanel.jsx");
const app = read("../MomosOps.jsx");
const readModel = read("../lib/read-model.js");

test("H110 conserva el original y versiona evidencia humana cerrada", () => {
...
test("la portada de Agencia muestra H110 y abre directamente la revisión visual", () => {
  assert.match(agencyPanel, /Calidad para IA/);
  assert.match(agencyPanel, /Activos listos para crear/);
