...
const AGENCY_SAFE_DB_KEYS = Object.freeze([
  ...
  "agencyCreativeVersions", "agencyCreativeIntelligence", "agencyCreativeIntelligenceReady",
  "agencyProductionPreflight", "agencyProductionPreflightReady",
  "agencyGenerationAuthorizations", "agencyGenerationAuthorizationReady",
  "agencyGenerationPilots", "agencyGenerationPilotReady",
  "agencyHumanization", "agencyHumanizationReady", "agencyModernProjectionStatus",
  "agencyDecisions", "agencyGrowthReady", "agencyIntegrations", "agencyLoopLearningReady",
  ...
  "officialLogoDeletionReady", "agencyIntegrationsReady", "creativeConnectorRuns",
  "visualLibraryReady", "visualQualityReady", "visualCleanMasterReady",
  "connectorPilotReady", "connectorPilotReadiness", "marketing_ideas",
